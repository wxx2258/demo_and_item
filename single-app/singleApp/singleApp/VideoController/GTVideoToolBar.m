...
//  singleApp
//
//  Created by xiaoxin.wu on 2022/2/4.
//
...
- (void)layoutWithModel:(id)model {
    ...
    _commentImageView.image = [UIImage imageNamed:@"icon.bundle/commad@3x.png"];
    _commentLabel.text = @"100";
    
    _likeImageView.image = [UIImage imageNamed:@"icon.bundle/like-icon@3x.png"];
    _likeLabel.text = @"25";
    
    _shareImageView.image = [UIImage imageNamed:@"icon.bundle/share2@3x.png"];
    _shareLabel.text = @"分享";
